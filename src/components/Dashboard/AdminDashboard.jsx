...
export default function AdminDashboard(props) {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 font-sans transition-colors duration-300 flex">
      ...
      <aside
        className={`hidden lg:flex flex-col justify-between border-r border-slate-200/80 dark:border-slate-800 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md sticky top-0 h-screen z-40 shrink-0 transition-all duration-300 ease-in-out ${

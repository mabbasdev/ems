                ...
                <div className="w-full max-w-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl p-6 space-y-4">
                    <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
                        <h3 className="text-base font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2">
                            {props.isEditing ? (
                                <>
                                    <Edit2 className="w-4 h-4 text-emerald-600" /> Modify Task Details
                                </>
                            ) : (
                                <>
                    ...
                    <form onSubmit={props.handleSaveTask} className="space-y-3.5">
                        <div className="space-y-1">
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    props.setNewTask({ ...props.newTask, title: e.target.value })
                                }
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="space-y-1">
                                ...
                                <select
                                    ...
                                    onChange={(e) =>
                                        props.setNewTask({ ...props.newTask, assignee: e.target.value })
                                    }
                            ...
                            <div className="space-y-1">
                                ...
                                <select
                                    ...
                                    onChange={(e) =>
                                        props.setNewTask({ ...props.newTask, priority: e.target.value })
                                    }
                                    className="w-full text-xs p-2.5 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-slate-900 dark:text-slate-100"
                                >
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="space-y-1">
                                ...
                                <Input
                                    ...
                                    onChange={(e) =>
                                        props.setNewTask({ ...props.newTask, department: e.target.value })
                                    }
                                    className="text-xs bg-slate-50 dark:bg-slate-950"
                                />
                            </div>
                            ...
                            <div className="space-y-1">
                                ...
                                <Input
                                    ...
                                    onChange={(e) =>
                                        props.setNewTask({ ...props.newTask, dueDate: e.target.value })
                                    }
                                    className="text-xs bg-slate-50 dark:bg-slate-950"
                                />
                            </div>
                        ...
                        <div className="flex items-center justify-end gap-2 pt-3 border-t border-slate-100 dark:border-slate-800">
                            ...
                            >
                                ...
                                {props.isEditing ? "Update Task" : "Dispatch Task"}
                            </Button>
                        </div>
                    </form>
                </div>
